    ...
    <section class="section__container about__container" id="about">
      ...
      <div class="about__content">
        ...
        <p class="section__description">
          Welcome to Siege Hotel, nestled in the heart of Asyut, Egypt. Our commitment to excellence ensures that your holiday
          experience surpasses all expectations. From luxurious accommodations to personalized services, we strive to create
          unforgettable memories for every guest. Discover the perfect blend of comfort and sophistication at Siege Hotel, where
          your dream holiday begins.
        </p>
        <div class="about__btn">
          <a target="_blank" href="https://en.wikipedia.org/wiki/Asyut"><button class="btn">Read More</button></a>
        </div>
      </div>
    </section>
    ...
    <section class="explore" id="explore">
      ...
      <div class="explore__bg">
        <div class="explore__content">
          ...
          <a target="_blank" href="https://www.menuegypt.com/kebda-al-falah-alexandria-"><button class="btn">Continue</button></a>
        </div>
      </div>
    </section>
